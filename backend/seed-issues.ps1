# Script to seed Issues table
# Usage: .\seed-issues.ps1 -Token "your-jwt-token-here"
...
$url = "http://localhost:5065/api/issues/seed"

try {
    Write-Host "Seeding issues..." -ForegroundColor Yellow
